...
AUTO_CONFIRMATION_ENABLED = os.getenv('ENABLE_AUTO_CONFIRMATION', 'false').lower() == 'true'
AUTO_CONFIRMATION_BASE_URL = os.getenv('AUTO_CONFIRMATION_BASE_URL')
if AUTO_CONFIRMATION_ENABLED:
    try:
        from auto_confirmation_system import auto_confirmation_system, start_auto_confirmation, get_auto_confirmation_stats, set_api_base_url
        print("✅ Sistema de confirmação automática carregado com sucesso")
        # Atualiza a base URL do worker para o domínio público quando fornecido
        if AUTO_CONFIRMATION_BASE_URL:
            set_api_base_url(AUTO_CONFIRMATION_BASE_URL)
            print(f"🌐 Auto confirmation base URL definida para {AUTO_CONFIRMATION_BASE_URL}")
    except ImportError:
    ...
    auto_confirmation_system = None
    print("ℹ️ Sistema de confirmação automática desativado por configuração")
...
# Force Resend in production
print("🚀 Produção - Resend ativado")
...
class EmailService:
    ...
    def send_serial_email(email: str, name: str, serial: str, transaction_id: str) -> bool:
        ...
        # try:
            ...
            print(f"🔍 Verifique as credenciais SMTP no ambiente")
            return False
            ...
            <body>
                <div class="container">
                    ...
                    <div style="text-align: center; margin-top: 30px;">
                        <a href="https://payment-api-b6th.onrender.com/admin/portal" 
                        ...
                        <p style="font-size: 14px; color: #666; margin-top: 10px;">
                            URL: https://payment-api-b6th.onrender.com/admin/portal
                        </p>
                    </div>
                    </div>
                </div>
                ...
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <div class="info-box" style="background: #e3f2fd; border-left-color: #2196f3;">
                            ...
                            <p style="font-size: 14px; color: #666; margin-top: 10px;">
                                <strong>URL:</strong> <a href="{APP_BASE_URL}/admin">{APP_BASE_URL}/admin</a>
                            </p>
                        </div>
        ...
        if payment['method'] == 'pix':
            ...
            if payment.get('status') != 'approved':
                ...
                return jsonify({
                    ...
                    'status': 'pending_approval',
                    'requires_proof': True,
                    'proof_upload_url': f'https://payment-api-b6th.onrender.com/upload-proof?payment_id={payment_id}'
                }), 400
...
def admin_portal_minimal():
    template_path = Path(__file__).resolve().parent / 'admin_portal.html'
    if template_path.exists():
        return template_path.read_text(encoding='utf-8')
    return render_template_string(
        "<!doctype html><html><head><meta charset='utf-8'><title>Portal Admin</title><body><p>Template ausente.</p></body></html>"
    )
